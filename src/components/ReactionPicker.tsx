                    ...
                    >
                        {REACTIONS.map((emoji) => (
                            <button
                                ...
                                className="w-8 h-8 md:w-9 md:h-9 flex items-center justify-center text-base md:text-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-full transition-colors active:scale-90"
                            >
                                {emoji}
                            </button>
                        ))}
